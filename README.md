...
| <sub>[Neural Network](https://github.com/VivekPa/IntroNeuralNetworks)</sub>                                                                                                                                               | <sub>Neural networks to predict stock prices.</sub>                                                                                                                                                  | <sub>9/10/18 6:34</sub>   | <sub>11/21/18 7:39</sub>  | <sub>488.0</sub>        | <sub>:heavy_multiplication_x:</sub> | <sub>:star:x4</sub> |<!-- [PLACEHOLDER_END:deep_learning] --> 
...
| <sub>[RL II](https://github.com/deependersingla/deep_trader)</sub>                                          | <sub>reinforcement learning on stock market and agent tries to learn trading.</sub>     | <sub>6/11/16 7:27</sub>  | <sub>1/22/18 14:35</sub> | <sub>1340.0</sub>       | <sub>:heavy_check_mark:</sub> | <sub></sub>         |<!-- [PLACEHOLDER_END:reinforcement_learning] --> 
...
| <sub>[Advanced ML](https://github.com/BlackArbsCEO/Adv_Fin_ML_Exercises)</sub> | <sub>Exercises too Financial Machine Learning (De Prado).</sub>           | <sub>4/25/18 17:22</sub> | <sub>1/16/20 17:25</sub> | <sub>958.0</sub>        | <sub>:heavy_check_mark:</sub> | <sub></sub>         |<!-- [PLACEHOLDER_END:data_processing_techniques_and_transformations] --> 
